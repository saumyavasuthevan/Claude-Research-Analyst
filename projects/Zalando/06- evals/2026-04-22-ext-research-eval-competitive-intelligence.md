...
| Metric | Score | Detail |
|---|---|---|
| Quant Claims Accuracy Rate | 80% | 12 confirmed / 15 checked (3 contradicted, 0 inconclusive excluded) — recalculated after human review |
...
- Quant Accuracy −3pp (v1→v2): v1 evaluated competitive-landscape.md. v2 evaluates competitive-intelligence.md; after human review, 3 claims confirmed contradicted (CAGR period/endpoint, ASOS active customers sourced from aggregator vs primary filing, SHEIN growth period mislabeled as YoY). 4 claims human-resolved as confirmed (Coupang Farfetch, ASOS Topshop sale, ASOS revenue, ASOS AI stylist). Final: 12 confirmed / 15 checked (3 contradicted, 0 inconclusive).
...
| CAGR 4.25% (2025–2030), reaching USD 154.78B by 2030 | 4.25% / USD 154.78B / 2025–2030 | SRC:mordor_eu_ecommerce_cagr_2025 | **Contradicted** — source shows 4.20% / USD 160.89B / 2026–2031 | Reviewed — remains contradicted | |
...
| Coupang completed Farfetch acquisition, January 2024 | January 2024 | SRC:coupang_ir_farfetch_acquisition | Confirmed | Human-resolved | |
| ASOS sold 75% stake Topshop/Topman to Heartland for £135M (~$180M), September 2024 | 75% / £135M / Sep 2024 | SRC:asos_topshop_heartland_jv | Confirmed | Human-resolved | |
| ASOS revenue £2.48B FY2025 (−15% YoY) | £2.48B / −15% | SRC:electroiq_asos_stats | Confirmed | Human-resolved | |
| ASOS 6.5M active customers FY2025 (−8% YoY) | 6.5M / −8% | SRC:electroiq_asos_stats | **Contradicted** — electroiq confirms 6.5M but primary filing (Investegate) shows 17.0M | Reviewed — remains contradicted | |
| SHEIN 145.7M avg monthly EU users (Feb–Jul 2025, +15.2M YoY) | 145.7M / +15.2M / "YoY" | SRC:cedcommerce_shein_europe_users | **Contradicted** — +15.2M is vs prior 6-month period, not year-on-year | Reviewed — remains contradicted | |
...
| ASOS "Styled By You" AI stylist / 100,000 curated outfits / November 2025 | Feature name, outfit count, date | SRC:guardian_asos_ai_stylist | Confirmed | Human-resolved | |
| Gap first major fashion brand checkout in Google Gemini, March 2026 | "first major" / March 2026 | SRC:gap_gemini_checkout | Confirmed | Human verified | |
...
| ID | Section | Found | Should Be | Status |
|---|---|---|---|---|
| M-1a | Market Overview — CAGR bullet 1 | `4.25% (2025–2030), reaching USD 154.78B by 2030 [Mordor Intelligence, 2025, SRC:mordor_eu_ecommerce_cagr_2025]` | `4.20% (2026–2031), reaching USD 160.89B by 2031 [Mordor Intelligence, 2025, SRC:mordor_eu_ecommerce_cagr_2025]` | Not applied — remains contradicted per human review |
| M-1b | Competitive Summary Matrix — SHEIN row | `+15.2M YoY` | `+15.2M vs prior 6-month period` — source (CedCommerce) compares Feb–Jul 2025 to the prior 6-month period (Aug 2024–Jan 2025), not year-on-year | Not applied — remains contradicted per human review |
| M-3 | Vinted Profile — Recent news 3 source cell | Missing `[SRC:id]` — Silicon Republic URL not retrieved | Add `[SRC:vinted_sacra_2026]` — sacra.com/c/vinted covers €8B valuation/share sale context | Pending |

#### Flagged for human review

| ID | Section | Issue | Response |
|---|---|---|---|
| M-1c | Competitive Summary Matrix / ASOS Profile | ASOS 6.5M active customers: electroiq source states 6.5M but contradicts ASOS primary filing (Investegate: 17.0M, −14% YoY). Recommend correcting to 17.0M with primary source, or adding [UNVERIFIED] flag. | Reviewed — remains contradicted per human decision |
...
| Check | Result | Detail |
|---|---|---|
| M-1 Quant Claims Accuracy | ⚠ 80% — 3 contradicted | See M-1 detail table |
| M-2 Link Validity | ⚠ 93% — 1 broken, 1 inconclusive | SRC:sheingroup_wroclaw 404 confirmed; SRC:guardian_asos_ai_stylist tool-blocked (excluded) |
| M-3 Citation Coverage | ⚠ 84.8% — 7 uncited fields | See Rates table for full list |
| M-4 Field Recall Rate | ✓ 100% | 46/46 resolvable fields filled |
| M-5 Placeholder Text | ✓ 0 violations | |
| M-6 Blocked Source Compliance | ✓ 0 violations | PitchBook used for public company status only, not financial figures |
| M-7 Competitor Count | ✓ 3 profiles | ASOS, SHEIN, Vinted |
| M-8 Banned Claim Patterns | ✓ 0 violations | |
| M-9 Stale Untagged Sources | ✓ 0 violations | |
