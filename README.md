...
| :--- | :--- | :--- |
| **Claude Code** | [Observability Hooks](.claude/hooks/) | Captures tool inputs and outputs via deterministic shell hooks — to avoid token consumption or instructions Claude may forget. Used by Debug Agent to trace exactly what went wrong and recommend improvements to agents and skills. |
